...
class DocForm extends Component {
  ...
  render() {
    ...
    return (
      <div className="animated fadeInLeft DocForm">
        ...
        <div className="row">
          ...
          <div className="col-xs-6">
            <DatePickerInput
              ...
              placeholder="Срок подготовки обучения"
        ...
        <div className="row">
          ...
          <div className="col-xs-6">
            <DatePickerInput
              ...
              className="my-custom-datepicker-component"
              placeholder="Обучение в подразделении"
        ...
        <div className="row">
          <div className="col-xs-6">
            <DatePickerInput
              ...
              className="my-custom-datepicker-component"
              placeholder="Дата регистрации программы"
          ...
          <div className="col-xs-6">
            <DatePickerInput
              name="dateOfDelivery"
              className="my-custom-datepicker-component"
              placeholder="Дата сдачи программы"
